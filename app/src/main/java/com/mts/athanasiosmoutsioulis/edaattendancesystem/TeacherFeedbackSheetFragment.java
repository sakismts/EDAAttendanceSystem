...
//
    ...
    public void updateStudentAttendances(String moduleId,String moduleType,String startDate,String endDate){
        this.moduleID=moduleType+" "+moduleId;
    ...
    public void create_pdf() throws FileNotFoundException,DocumentException {
        ...
        String filename="feedback"+this.moduleID+"_"+this.SDate;
        ;
...
//            }
        ...
        Paragraph paragraph = new Paragraph("Feedbacks for the " + moduleID);
        ...
        insertCell(table, "Student id", Element.ALIGN_CENTER, 1, bf12);
        insertCell(table, "Feedback ", Element.ALIGN_LEFT, 1, bf12);
        ...
        for (Attendance tmp:model.getTeacherFeedback()){



            String name="";
            if (tmp.getAnonymous().equals("false")) {
                name="anonymous";
            }else{
